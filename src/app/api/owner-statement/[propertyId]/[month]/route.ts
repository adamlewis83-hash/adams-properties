  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(Text, { style: styles.brand }, "JAM Properties"),
      ...
      React.createElement(Text, { style: styles.footer, fixed: true }, `JAM Properties · ${data.propertyName} · ${data.monthLabel}`),
    ),
  );
}
